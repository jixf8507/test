...
public class MerchantChargeRecordExport extends BaseExport {
	@Override
	protected void writeTile() throws Exception {
		...
		Label label = new Label(0, 0, "商家收费记录明细", wffBold);
	...
	protected void writeHeader() throws Exception {
		...
		wsheet.addCell(new Label(column++, 1, "收费金额", wctB));
		wsheet.addCell(new Label(column++, 1, "收费时间", wctB));
		wsheet.addCell(new Label(column++, 1, "收费类型", wctB));		
		wsheet.addCell(new Label(column++, 1, "经办人", wctB));
		wsheet.addCell(new Label(column++, 1, "收费点", wctB));
