 ...
 * @date 2015年10月12日
 */
public class CustomerFreezeExport extends BaseExport {
	...
	protected void writeTile() throws Exception {
		...
		Label label = new Label(0, 0, "商家已冻结客户信息列表", wffBold);
	...
	protected void writeHeader() throws Exception {
		...
		wsheet.addCell(new Label(column++, 1, "冻结原因", wctB));
		wsheet.addCell(new Label(column++, 1, "冻结时间", wctB));
		wsheet.addCell(new Label(column++, 1, "冻结经办人", wctB));
	}
	...
	protected String fileName() {
		String filename = "商家已冻结客户信息列表.xls";
		try {
