 ...
 * @author sdf
 */
public class AssetRepairTotelExport extends BaseExport {
	@Override
	protected void writeTile() throws Exception {
		...
		Label label = new Label(0, 0, "固定资产维修记录列表", wffBold);
	...
	protected void writeHeader() throws Exception {
		...
		wsheet.addCell(new Label(column++, 1, "维修配件", wctB));
		wsheet.addCell(new Label(column++, 1, "维修状态", wctB));
	}
	...
	protected String fileName() {
		String filename = "固定资产维修记录信息.xls";
		try {
