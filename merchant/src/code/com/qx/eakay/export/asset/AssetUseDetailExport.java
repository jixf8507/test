 ...
 * @author sdf
 */
public class AssetUseDetailExport extends BaseExport {
	@Override
	protected void writeTile() throws Exception {
		...
		Label label = new Label(0, 0, "固定资产领用详细列表", wffBold);
	...
	protected void writeHeader() throws Exception {
		...
		wsheet.addCell(new Label(column++, 1, "领取记录号", wctB));
	...
	protected String fileName() {
		String filename = "固定资产领用详细信息.xls";
		try {
