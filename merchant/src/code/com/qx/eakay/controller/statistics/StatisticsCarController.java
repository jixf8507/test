...
import com.qx.eakay.service.statistics.StatisticsCarService;
...
public class StatisticsCarController extends BaseController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("useCount.htm")
	public ModelAndView useCount() throws Exception {
		return new ModelAndView("statistics/carUseCount");
	}
	...
	public PageResults ajaxData(String aoData, String paraData,
		...
		PageResults pageResults = statisticsCarService.findCarUsesPage(
	...
	public ModelAndView exportToExcel(String paraData, HttpSession session,
		...
		JSONObject jsonObject = getJsonPara(paraData, session);
		statisticsCarService.excelExportCarUse(response, jsonObject);
		return null;
	}
