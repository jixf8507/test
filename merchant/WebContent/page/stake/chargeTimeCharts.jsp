...
<script type="text/javascript" src="${ctx}/js/page/stake/chargeTimeCharts.js"></script>
</head>
		...
		<div class="centercontent">
			...
			<div id="contentwrapper" class="contentwrapper">
				<div class="overviewhead">
						...
						开始充电日期: &nbsp;<input type="text" id="beginTime" /> &nbsp; &nbsp;
						结束充电日期: &nbsp;&nbsp;<input type="text" id="endTime" /> &nbsp; &nbsp;
