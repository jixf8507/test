...
<script type="text/javascript"
	src="${ctx}/js/page/stake/deviceParentEdite.js"></script>
</head>
	...
	<form id="form1" class="stdform stdform2" method="post">
		<p>
			<label>出厂编号</label> <span class="field"><input type="text"
				style="width: 200px;" name="factoryNo" id="factoryNo" value="${deviceNamePO.factoryNo}"
		...
		<%-- <p>
			<label>位置坐标</label> <span class="field"> <input readonly="readonly"
