...
<script type="text/javascript"
	src="${ctx}/js/page/stake/charge.js"></script>
</head>
				...
				<div id="list" class="subcontent">
					<form id="form1" class="stdform stdform2" method="post">
						<p>
							...
							<input type="hidden" value="${costPO.id }" id="id" name="id"/>
							</span>
						</p>
						<p>
						...
						<p>
							...
							<input type="hidden" value="${costPO.kind }" id="Kind" name="Kind"/>
							</span>
						</p>
						<p>
						...
						<p>
							...
							<input type="hidden" value="${costPO.cost }" id="cost" name="cost"/>
							<input type="hidden" value="${costPO.customerPO.accountPO.balance }" id="balance" name="balance"/>
							</span>
						</p>
						<p>
