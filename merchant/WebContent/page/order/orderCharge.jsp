...
<script type="text/javascript" src="${ctx}/js/page/order/orderCharge.js"></script>
</head>
			...
			<div id="contentwrapper" class="contentwrapper">
				...
				<div id="normal" class="subcontent">
					<div class="overviewhead">
						<div class="overviewselect">
							...
							</select>&nbsp; &nbsp; <select id="returnSiteId" name="select"
								class="chzn-select" style="width: 200px;" tabindex="2">
								<option value="">请选择租赁点</option>
							</select>
						</div>
						<!--floatright-->
						车牌: &nbsp;<input type="text" id="returnCarNumber" /> &nbsp;
				...
				<div id="unit" class="subcontent" style="display: none;">
					<div class="overviewhead">
						...
						车牌: &nbsp;<input type="text" id="carNumber1" /> &nbsp; &nbsp; 单位:
						&nbsp;<input type="text" id="enterpriseName" /> &nbsp; 电话: &nbsp;<input
							type="text" id="contactPhone" /> &nbsp; &nbsp;
