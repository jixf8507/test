...
<script type="text/javascript" src="${ctx}/js/page/order/getConfirm.js"></script>
		...
		<div class="centercontent">
			...
			<div id="contentwrapper" class="contentwrapper">
				...
				<div id="unit" class="subcontent" style="display: none;">
					<div class="overviewhead">
						<div class="overviewselect">
						<select id="priceTypeTableName1" name="select" class="chzn-select"
								style="width: 200px;" tabindex="2">
								<option value="">请选择租赁类型</option>								
								<option value="wh_hours_price_type">分时租赁</option>								
								<option value="month_lease_price_type">长期租赁</option>								
							</select>&nbsp; &nbsp;
							<select id="relityGetSiteId1" name="select" class="chzn-select"
								style="width: 200px;" tabindex="2">
								<option value="">请选择租赁点</option>								
							</select>
						</div>
