...
<script type="text/javascript"
	src="${ctx}/js/page/asset/assetReduceAdd.js"></script>
</head>

					<form id="form2" class="stdform stdform2" method="post">
						<p>
							<label>处置日期</label> <span class="field"> <input
								type="text" name="reduceDate" id="reduceDate" class="longinput"
								style="width:200px;" />&nbsp;&nbsp;
							</span>
						</p>
						<p>
							<label>处置原因</label> <span class="field"> <input
								type="text" name="reduceReason" id="reduceReason" class="longinput"
								style="width:200px;" />&nbsp;&nbsp;
							</span>
						</p>
						<p>
