...
<script type="text/javascript" src="${ctx}/js/page/asset/assetPage.js"></script>
</head>
				...
				<div id="normal" class="subcontent">
					<div class="overviewhead">
						<div class="overviewselect">
							...
							</select> &nbsp; <select id="flag" name="flag" class="chzn-select"
								style="width: 200px;" tabindex="2">
						...
						<br /> 资产名称: &nbsp;<input type="text" id="assetsName"
							style="width: 200px;" /> &nbsp; &nbsp;&nbsp; &nbsp;
