...
<script type="text/javascript" src="${ctx}/js/page/statistics/charge.js"></script>
</head>
			...
			<div id="contentwrapper" class="contentwrapper">
				...
				<div class="one_half " style="width: 47%; min-width: 500px;">
					<div class="widgetbox">
						<div class="widgetcontent userlistwidget nopadding">
							<a class="more" href="#"
								style="text-align: left; padding-left: 10px;">充电站充电收费统计图</a>
				...
				<div class="one_half last" style="width: 47%; min-width: 500px;">
					<div class="widgetbox">
						<div class="widgetcontent userlistwidget nopadding">
							<a class="more" href="#"
								style="text-align: left; padding-left: 10px;">充电站充电次数统计图</a>
				...
				<div class="one_half" style="width: 98%; min-width: 800px;">
					<div class="widgetbox">
						<div class="widgetcontent userlistwidget nopadding">
							<a class="more" href="#"
								style="text-align: left; padding-left: 10px;">月充电收费统计图</a>
							<div id="month" style="height: 300px;"></div>
							<br /> <small>每月充电收费变化</small>
						</div>
					</div>
				</div>
				...
				<div class="one_half" style="width: 98%; min-width: 800px;">
					<div class="widgetbox">
						<div class="widgetcontent userlistwidget nopadding">
							<a class="more" href="#"
								style="text-align: left; padding-left: 10px;">日充电收费统计图</a>
							<div id="day" style="height: 300px;"></div>
							<br /> <small>每日充电收费变化</small>
						</div>
					</div>
				</div>
				<!--one_half-->
