...
<script type="text/javascript" src="${ctx}/js/page/car/status.js"></script>
</head>
	...
	<div class="bodywrapper">
		...
		<div class="centercontent">
			<div class="pageheader">
				...
				<ul class="hornav">
					<li class="current"><a href="#use" id="useDiv">使用中...</a></li>
				...
				<div id="use" class="subcontent">
					<div class="overviewhead">
						<div class="overviewselect">
							<select id="orderType" name="select" class="chzn-select"
								style="width: 200px;" tabindex="2">
								<option value="">请选择使用类型</option>
								<option value="1">客户租车</option>
								<option value="2">企业租车</option>
								<option value="3">车辆调度</option>
								<option value="4">公务用车</option>
							</select>&nbsp; &nbsp;
