...
<script type="text/javascript"
	src="${ctx}/js/page/customer/assureCharge.js"></script>
</head>
			...
			<div id="contentwrapper" class="contentwrapper">
				<div id="list" class="subcontent">
					...
					<form id="form1" class="stdform stdform2" method="post"
						action="${ctx}/customer/account/saveAssureCharge.htm?">
						<p>
						...
						<p>
							<label>保证金余额</label> <span class="field"><input
								type="text" readonly="readonly" id="balance" class="longinput"
								style="width: 350px;" />&nbsp;&nbsp;</span>
						</p>
						<p>
